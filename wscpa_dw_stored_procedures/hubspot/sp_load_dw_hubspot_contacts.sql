-- Stored procedure to upsert data from staging into dw_hubspot_contacts
DROP PROCEDURE IF EXISTS wscpa_dw.sp_load_dw_hubspot_contacts;
DELIMITER $$
CREATE PROCEDURE sp_load_dw_hubspot_contacts()
BEGIN
